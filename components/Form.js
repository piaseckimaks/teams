      ...
      <div className="hero h-full w-full mx-auto bg-fixed" style={{backgroundImage: 'url("https://images.pexels.com/photos/1527934/pexels-photo-1527934.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260")'}} >
          ...
          <div className="text-center hero-content text-neutral-content">
            ...
            <div className="relative max-w-md card w-96 p-5 bg-base-200">
              ...
              <h2><span className="mr-1">Or</span><Link href="signup"><a className="link-accent">new account!</a></Link></h2>
              <form>
                ...
                <div className="form-control mb-5">
                  <label className="label">
                    <span className="label-text">Password</span><span><Link href="#"><a className="text-sm">Forgot password?</a></Link></span>
                  </label> 
                  <input type="password" required placeholder="username" className="input input-sm input-bordered" />
                </div> 


                <button type="submit" className="btn btn-accent btn-sm w-full">sign in</button>
              </form>

              <div className="divider">OR</div> 

              <button className="btn btn-sm btn-accent mb-3 relative">
                <span className="absolute left-16" >continue with github</span> 
                <svg role="img" viewBox="0 0 24 24" width="24" height="24" xmlns="http://www.w3.org/2000/svg" className="absolute fill-current text-white right-16">
                  <title>GitHub</title>
              ...
              <button className="btn btn-sm btn-accent relative">
                <span className="absolute left-16" >continue with google</span> 
                <svg role="img" viewBox="0 0 24 24" width="24" height="24" xmlns="http://www.w3.org/2000/svg" className="absolute fill-current text-white right-16">
                  <title>Google</title>
