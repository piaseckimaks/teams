...
const iconsStyling = "inline-block w-6 h-6 text-base-content group-hover:text-base-100"
...
const upperButtons = [
    {
        name: 'home',
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className={iconsStyling} viewBox="0 0 16 16">
